...
def dados():
    ...
    requisicao_fazenda = rq.get('https://www.gov.br/fazenda/pt-br/assuntos/noticias/2024')
    html_fazenda = requisicao_fazenda.content
    sopa_fazenda = bs(html_fazenda, 'html.parser')

    noticias_ministerio = sopa_fazenda.find_all('article', class_='tileItem visualIEFloatFix tile-collective-nitf-content')
    ...
    noticias_uol = sopa_uol.find_all('div', class_='thumbnails-item no-image align-horizontal list col-xs-8 col-sm-12 small col-sm-24 small')
    ...
    noticia_estadao = sopa_estadao.find_all('div', class_='noticias-mais-recenter--item')
    ...
    conteudo_html = render_template('radaresg.html', fazenda=economia_fazenda, uol=economia_uol, estadao=economia_estadao)
